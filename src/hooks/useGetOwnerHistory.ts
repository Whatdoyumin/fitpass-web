...
export const useGetMonthHistory = (fitnessId: string|null, page: number = 0, size: number = 10) => {
  return useQuery({
...
export const useGetUsageHistory = (fitnessId: string|null, page: number = 0, size: number = 10) => {
  return useQuery({
