...
const Modal = ({ isOpen, onClose, onSuccess, title, btn1Text, btn2Text }: IModalProps) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black-700 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white-100 p-6 rounded-lg w-[300px] h-[152px] text-center px-4 pt-8 pb-5">
