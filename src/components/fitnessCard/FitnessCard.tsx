          ...
          <div className="flex rounded bg-white-100 relative h-[117px]" key={index}
            ...
            <div className="flex flex-col w-[190px] h-[84px]">
              <div className="p-4 rounded-r-[5px]">
                ...
                <div className={`absolute flex justify-center items-center w-15 bottom-4 right-4 text-blue-400 rounded-[15px] h-[22px] text-[10px] font-bold text-center py-[5px] px-[10px] ${statusStyle} `}>
                  {statusText}
                </div>
              </div>
