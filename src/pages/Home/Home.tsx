...
function Home() {
  ...
  return (
    <div className="bg-white-200 w-full min-h-full overflow-y-auto flex flex-col">
      ...
      <div className="flex flex-col w-[390px] rounded-t-[15px] bg-white-200 absolute top-[340px] z-5 ">
        ...
        {/* <div className="flex-grow w-[390px] pl-4 my-3 overflow-hidden mt-6"> */}
        ...
        {/* <div className="flex-grow w-[390px] pl-4 my-7 overflow-hidden"> */}
