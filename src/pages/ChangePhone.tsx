...
function ChangePhone() {
  ...
  return (
    <div className="bg-white-100 px-[20px] py-[29px] max-w-[400px] mx-auto">
      {/* 이름 입력 */}
      ...
      <div className="mb-[162px]">
        ...
        <div className="flex items-center gap-2 mt-[10px] h-[50px]">
          <input
            type="text"
            value={phoneNumber}
            onChange={(e) => setPhoneNumber(e.target.value)}
            placeholder="휴대폰 번호를 입력해주세요"
            className="flex-1 p-3 border border-gray-300 rounded-md text-[14px] h-full"
          />
          <button
            type="button"
        ...
        <div className="flex items-center gap-2 mt-[10px] h-[50px] relative">
          <div className="relative">
            <input
              ...
              className={`w-full max-w-[246px] p-3 border rounded-md text-[14px] h-[50px] pr-[50px] ${
